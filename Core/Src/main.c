...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GREEN_Pin|BLUE_Pin|RED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PA2 PA4 PA5 PA11
                           PA12 PA15 */
  GPIO_InitStruct.Pin = GPIO_PIN_2|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_11
